...
### Project Overview
Loan Approval Prediction System is a machine learning-based classification project that predicts whether a loan application will be approved or rejected based on applicant details such as income, education, credit history, and loan amount. The project includes data preprocessing, feature encoding, model training, and evaluation. Multinomial Naive Bayes was selected as the final model due to its perfect precision score, ensuring reliable loan approval predictions.
